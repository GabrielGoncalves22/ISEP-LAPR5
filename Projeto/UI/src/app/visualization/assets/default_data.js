...
export const playerData = {
    ...
    url: "./app/visualization/assets/models/gltf/RobotExpressive/RobotExpressive.glb",
    ...
    runningFactor: 3.5, // Affects walking speed and turning speed
    keyCodes: { fixedView: "Digit1", firstPersonView: "Digit2", thirdPersonView: "Digit3", topView: "Digit4", viewMode: "KeyV", userInterface: "KeyU", miniMap: "KeyM", help: "KeyH", statistics: "KeyS", run: "KeyR", left: "ArrowLeft", right: "ArrowRight", backward: "ArrowDown", forward: "ArrowUp", dance: "KeyJ", opening: "KeyY", clicking: "KeyN", wave: "KeyW" }
}

export const elevatorData = {
    url: "./app/visualization/assets/models/gltf/elevator/elevator.glb",
    scale: new THREE.Vector3(0.5, 0.5, 0.5),
    initialDirection: 0.0, // Expressed in degrees
    keyCodes: { open: "KeyE", close: "KeyX" },
    displayName: "Elevator"
}

export const doorData = {
    url: "./app/visualization/assets/models/gltf/door/door.glb",
    scale: new THREE.Vector3(0.35, 0.3, 0.2),
